...
gh—ost是github的dba开源一款使用go语言开发的MySQL在线改表工具，[github地址](https://github.com/github/gh-ost)，解决了目前采用pt-online-schema-change遇到的一些问题，思路也很新颖；作者很厉害，也是是openark kit工具集的作者（主要是用python写的一套工具集）；
